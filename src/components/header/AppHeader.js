...
const AppHeader = ({ activePage, isFixed = false }) => {
    return (
        <Menu 
            ...
            size='large'>
            <Container>
                <Menu.Item as={Link} to='/' active={ activePage === 'Home' }>Home</Menu.Item>
                <Menu.Item as={Link} to='/blog' active={ activePage === 'Blog' }>Blog</Menu.Item>
                <Menu.Item as={Link} to='/profile' active={ activePage === 'Resume'}>Resume</Menu.Item>
