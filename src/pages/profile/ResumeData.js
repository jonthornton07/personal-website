...
const ncrPartTwo = {
    ...
    title: "Software Engineer III",
    highlights: [
        "Architect for the next generation Aloha User Interface.",
        "Leader developer of 30+ developers."
    ]
}

export const resumeData = [ncrPartTwo, coke, ncrPartOne, coxMediaGroup]